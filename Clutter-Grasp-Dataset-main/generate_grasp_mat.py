...
label_path = 'F:/Graduate/WeekLearn/Alunwen/AFFGA-Net/code/realsense/out/1'
save_path = 'F:/Graduate/WeekLearn/Alunwen/AFFGA-Net/code/realsense/out/1'
...
def run():
    ...
    for label_file in label_files:
        ...
        with open(label_file) as f:
            ...
            # 保存 mat
            save_name = os.path.join(save_path, os.path.basename(label_file).replace('.txt', 'grasp.mat'))
